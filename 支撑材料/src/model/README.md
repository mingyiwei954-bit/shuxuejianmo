...
config/final.yaml 保留原候选默认值，正式算法必须读取 frozen/resolved_config.json 中的一月选定结果。当前论文定义、假设、公式与新证据见论文修订源文件/body.md 和 scripts/revision_document.py，paper/main.md 为旧稿来源，不是本轮定稿。
